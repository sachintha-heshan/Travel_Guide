...
<head>
	...
	<title>Add new place - TourGuide</title>
...
<body>
	...
	<div class="content">
        ...
        <form action="../insertLocalPlace" class="form-group" method="POST" enctype="multipart/form-data">
            <div class="input-group">
                <label>Enter Place Name</label>
                <input type="text" name="placeName" required autocomplete="off" placeholder="Nine Arches Bridge">
            </div>
            ...
            <div class="input-group">
                ...
                <input type="text" name="location" required autocomplete="off" placeholder="Ella">
            </div>
            <div class="input-group">
