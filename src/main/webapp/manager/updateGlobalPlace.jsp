...
<body>
	...
	<div class="content">
        ...
        <form action="../updateglobalPlace" class="form-group" method="POST" enctype="multipart/form-data">
            ...
            <%
	   		try{
				...
				String sql1 = "select * from globallistings where listingID="+listingID+"";
				stmt = conn.createStatement();
            ...
            <input type="submit" name="submit" value="Update Place" class="btn">
        </form>
    </div>
</body>
</html>